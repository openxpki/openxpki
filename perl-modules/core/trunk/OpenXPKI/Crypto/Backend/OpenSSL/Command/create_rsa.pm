## OpenXPKI::Crypto::Backend::OpenSSL::Command::create_rsa
...
package OpenXPKI::Crypto::Backend::OpenSSL::Command::create_rsa;
...
returns the new encrypted and PEM encoded RSA key
