...
sub _build_certs {
    return {
        acme_root => OpenXPKI::Test::CertHelper::Database::PEM->new(
            label => "ACME Root CA",
            db => {
        ...
        acme_signer => OpenXPKI::Test::CertHelper::Database::PEM->new(
        ...
        acme_client => OpenXPKI::Test::CertHelper::Database::PEM->new(
            label => "ACME Client",
            db => {
        ...
        acme2_root => OpenXPKI::Test::CertHelper::Database::PEM->new(
        ...
        acme2_signer => OpenXPKI::Test::CertHelper::Database::PEM->new(
        ...
        acme2_client => OpenXPKI::Test::CertHelper::Database::PEM->new(
            label => "ACME-2 Client",
            db => {
        ...
        expired_root => OpenXPKI::Test::CertHelper::Database::PEM->new(
        ...
        expired_signer => OpenXPKI::Test::CertHelper::Database::PEM->new(
        ...
        expired_client => OpenXPKI::Test::CertHelper::Database::PEM->new(
        ...
        orphan => OpenXPKI::Test::CertHelper::Database::PEM->new(
