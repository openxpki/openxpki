...
```html
<OxiDownload @type="base64" @data={{this.fileData}} @mimeType="text/plain" @fileName="book.txt" @autoDownload={{true}} @hide={{true}}/>
<OxiDownload @type="link" @data="img/logo.png" @fileName="openxpki.png" />
```
*/
