...
print STDERR "OpenXPKI::Crypto::Backend::OpenSSL::ECDH\n" if $ENV{VERBOSE};

BEGIN { use_ok('OpenXPKI::Crypto::Backend::OpenSSL::ECDH') };
...
dies_ok(sub { $puberr = OpenXPKI::Crypto::Backend::OpenSSL::ECDH::get_ec_pub_key("") ;} );
...
dies_ok(sub { OpenXPKI::Crypto::Backend::OpenSSL::ECDH::get_ecdh_key() ;} );

dies_ok(sub { OpenXPKI::Crypto::Backend::OpenSSL::ECDH::get_ecdh_key("") ;} );

#test new key generation withan invalid NID
dies_ok(sub {OpenXPKI::Crypto::Backend::OpenSSL::ECDH::new_ec_keypair(1) });

dies_ok(sub {OpenXPKI::Crypto::Backend::OpenSSL::ECDH::new_ec_keypair('foo') });
