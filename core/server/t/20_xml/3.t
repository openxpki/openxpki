...
## create new object
my $obj = OpenXPKI::XML::Cache->new(CONFIG => "t/20_xml/top.xml");
...
$obj = undef;
eval {
    $obj = OpenXPKI::XML::Cache->new(CONFIG => "t/20_xml/top2.xml");
};
...
$obj = undef;
eval {
    $obj = OpenXPKI::XML::Cache->new(CONFIG => 't/20_xml/loop1.xml');
};
