...
package OpenXPKI::Crypto::Backend::OpenSSL::Command::create_key::GOST94CP;
...
sub get_command
{
    ...
    my $command = "req -newkey gost94cp:";
    ...
    $command .= ' -subj "/dc=ru/dc=OpenXPKI/dc=key generation only/dc=gost94cp"';
...
This command creates GOST94 keys in CP mode.
...
This function verifies GOST94CP-specific algorithm parameters.

=head2 get_command

This is an implementation of the
OpenXPKI::Crypto::Backend::OpenSSL::Command::create_key::get_command
for GOST94CP algorithm.
