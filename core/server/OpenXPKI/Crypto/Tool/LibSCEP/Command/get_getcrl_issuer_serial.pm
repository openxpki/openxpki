## OpenXPKI::Crypto::Tool::LibSCEP::Command::get_getcert_serial.pm
## Written 2013 by Oliver Welter for the OpenXPKI project
## (C) Copyright 2013 by The OpenXPKI Project
package OpenXPKI::Crypto::Tool::LibSCEP::Command::get_getcrl_issuer_serial;
...
sub get_result
{
    ...
    while ((shift @crl_info) !~ /Issuer and Serial:/) {
        if (scalar(@crl_info) < 2) {
            OpenXPKI::Exception->throw(
                message => 'I18N_OPENXPKI_CRYPTO_TOOL_LIBSCEP_COMMAND_GET_CRL_ISSUER_SERIAL_FAILED',
            );
        }
    }
