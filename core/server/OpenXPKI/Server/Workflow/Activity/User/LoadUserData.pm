...
Load the user data identified by either username or email (at least one of them must be provided as param).
All user attributes are then stored in the workflow context
