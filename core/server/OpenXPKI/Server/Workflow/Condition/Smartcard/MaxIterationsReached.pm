# OpenXPKI::Server::Workflow::Condition::Smartcard::MaxIterationsReached.pm
...
package OpenXPKI::Server::Workflow::Condition::Smartcard::MaxIterationsReached;
...
OpenXPKI::Server::Workflow::Condition::Smartcard::MaxIterationsReached
