# OpenXPKI::Server::Workflow::Condition::Smartcard::OwnerAbortedWorkflow.pm
...
package OpenXPKI::Server::Workflow::Condition::Smartcard::OwnerAbortedWorkflow;
...
OpenXPKI::Server::Workflow::Condition::Smartcard::OwnerAbortedWorkflow
