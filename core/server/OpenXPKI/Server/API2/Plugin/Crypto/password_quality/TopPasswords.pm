...
Contains a list of the top 10,000 passwords seen in data leaks from Troy Hunt's
"Have I Been Pwned" (https://haveibeenpwned.com) data set.
...
Returns an I<ArrayRef> of the top passwords.
...
my $PASSWORDS = do {
    ...
    my $_data_txt;
    gunzip \$_data_zip, \$_data_txt or die("gunzip of inline __DATA__ failed: $GunzipError");
    [ split /\r?\n/, $_data_txt ];
};
