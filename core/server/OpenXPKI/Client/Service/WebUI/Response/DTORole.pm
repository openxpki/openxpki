...
B<Not intended for direct use.> Please use L<OpenXPKI::Client::Service::WebUI::Response::DTO>
instead.
...
C<OpenXPKI::Client::Service::WebUI::Response::DTORole> (or an L<ArrayRef> containing such
...
sub resolve {
    ...
    for my $attr (@all_attrs) {
        ...
        my $maybe_resolve = sub { my $v = shift; return (does_role($v, 'OpenXPKI::Client::Service::WebUI::Response::DTORole') ? $v->resolve : $v) };
