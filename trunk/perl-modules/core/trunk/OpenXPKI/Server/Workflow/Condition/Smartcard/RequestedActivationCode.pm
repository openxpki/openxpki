# OpenXPKI::Server::Workflow::Condition::Smartcard::RequestedActivationCode.pm
...
package OpenXPKI::Server::Workflow::Condition::Smartcard::RequestedActivationCode;
...
OpenXPKI::Server::Workflow::Condition::Smartcard::RequestedActivationCode
