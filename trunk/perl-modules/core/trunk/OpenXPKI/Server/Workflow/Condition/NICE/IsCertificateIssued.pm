...
sub evaluate {
    ...
    condition_error("I18N_OPENXPKI_SERVER_CONNECTOR_VICE_CONDITION_CERTIFICATEISSUED_NOENTRY") unless $context->param('cert_identifier');
    
    condition_error("I18N_OPENXPKI_SERVER_CONNECTOR_VICE_CONDITION_CERTIFICATEISSUED_STILLPENDING") if $context->param('cert_identifier') eq 'pending';
...
OpenXPKI::Server::Workflow::Condition::VICE::IsCertificateIssued
