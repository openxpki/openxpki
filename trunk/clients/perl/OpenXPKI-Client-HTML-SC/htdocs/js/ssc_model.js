...
var SSC_MODEL = new Class(
		{
			...
			init_env: function (){
				...
				//this.stateFilter[11]= 'POLICY_INPUT_REQUI';
				this.ECDH = null;
			...
			sc_test_card: function(pin, viewCb) {
				...
				for( var j=0 ; j < res.length-1 ; j++ ){
					...
					for(var i=0; i < this.user.parsedCerts.length ; i++ ){
						...
						//this.user.parsedCerts[i].VISUAL_STATUS = "";
						window.dbg.log("set   "+ this.user.parsedCerts[i].MODULUS_HASH);
					...
					try {
						...
						for ( var i = 0; i < data.errors.length; i++) {
							...
							if (data.errors[i] === 'I18N_OPENXPKI_CLIENT_WEBAPI_SC_START_SESSION_ERROR_CARDID_NOTACCEPTED') {
								...
								sscView.showPopUp('E_card_not_registe', 'cross',this.errors2htmlstring(errorList) );
								//viewCb('cardUnknown');
