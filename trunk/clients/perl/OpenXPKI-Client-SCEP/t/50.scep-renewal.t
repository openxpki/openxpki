...
SKIP: {
    ...
    # TODO -- skip if sscep does not support renewal
  ...
  FORK:
	...
	# child process pid is available in $pid
        ...
        `$openssl genrsa -out t/instance/renewal_key.pem 1024 $stderr`;
`(echo '.'; echo '.'; echo '.'; echo 'OpenXPKI'; echo 'SCEP test certificate'; echo 'SCEP test certificate'; echo '.'; echo '.'; echo '.')| openssl req -new -key t/instance/renewal_key.pem -out t/instance/renewal_request.csr $stderr`;
        ...
        ok($scep_result =~ m{pkistatus:\ SUCCESS}xms);
        ok(-s 't/instance/renewal_certificate');
