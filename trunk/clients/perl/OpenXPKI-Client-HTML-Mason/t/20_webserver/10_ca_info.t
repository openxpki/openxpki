...
$mech->follow_link(text => 'I18N_OPENXPKI_HTML_MENU_CA_INFO', n => '1');
$mech->follow_link(text => 'I18N_OPENXPKI_HTML_MENU_PKI_REALM_INFO');

like($mech->response->content, qr/I18N_OPENXPKI_DEPLOYMENT_TEST_DUMMY_CA/, 'Dummy deployment realm is listed'), 

$mech->follow_link(text => 'I18N_OPENXPKI_HTML_MENU_LIST_ISSUER', n => '1');
