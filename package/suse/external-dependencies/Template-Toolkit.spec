...
#       --spec-only --version=2.15 '--author=Andy Wardley' Template-Toolkit-2.15.tar.gz
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Template-Toolkit
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 0

name:      perl-Template-Toolkit
summary:   Template-Toolkit - comprehensive template processing system
version:   2.15
release:   1
vendor:    Andy Wardley
...
%{__perl} -MFile::Find -le '
    ...
    print "%doc  images TODO bin parser xs Changes INSTALL docs templates README examples";
