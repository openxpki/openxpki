...
#       --spec-only --version=1.0700 '--author=Rick Measham' DateTime-Format-Strptime-1.0700.tar.gz
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname DateTime-Format-Strptime
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    DateTime-Format-Strptime-1.0700.tar.gz
