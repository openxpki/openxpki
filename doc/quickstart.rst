...
Note, fastcgi module should be enabled explicitly, otherwise, .fcgi file will be treated as plain text::
    ...
    ln -s /etc/apche2/mods-enabled/fastcgi.conf /etc/apache2/mods-available/fastcgi.conf
    ln -s /etc/apche2/mods-enabled/fastcgi.load /etc/apache2/mods-available/fastcgi.load
