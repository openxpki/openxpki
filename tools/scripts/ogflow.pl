...
if ( $plist->{UserInfo}
    and exists $plist->{UserInfo}->value()->{kMDItemDescription} )
{
    $descPrefix = $plist->{UserInfo}->value()->{kMDItemDescription}->value();
}

if ( $plist->{UserInfo}
    and exists $plist->{UserInfo}->value()->{kMDItemKeywords} )
{
